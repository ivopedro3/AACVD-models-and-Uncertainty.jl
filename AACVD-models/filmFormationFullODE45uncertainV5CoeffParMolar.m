function [parameters, IC] = filmFormationFullODE45uncertainV5CoeffParMolar(t,y)
...
fileID2 = fopen('previousC.txt','r');
formatSpec = '%f %f %f %f';
sizeA = [4 1];
C_iin = fscanf(fileID2,formatSpec,sizeA);
fclose(fileID2);
