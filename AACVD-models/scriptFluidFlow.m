...
%Parameters = [Q, nu, ro, Cp, Pr, k]
fluidFlow([2.5e-3 52.69e-6 0.5804 1051 0.685 .0469])

x = [2.5e-3 52.69e-6 0.5804 1051 0.685 .0469];
...
y = y - 273.15; %K to �C
plot(x, y,'LineWidth',4)
% legend('High heat transfer coefficient','Low heat transfer coefficient')
legend('Low flow rate','High flow rate')
